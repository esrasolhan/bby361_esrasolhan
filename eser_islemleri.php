...
<html lang="en" class="h-100">
  <head>
    ...
    <title>BBY361 Kitap İşlemleri</title>
...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5"> Kitap İşlemleri</h1>
        <p class="lead">Bu sayfada veri tabanında yer alan kitaplar ile ilgili işlemler yapabilir ya da yeni kitap ekleyebilirsiniz.</p>
    <h2>Kitap Ekle</h2>
      <p><a href="eser_ekle.php">Yeni kitap ekle!</a></p>
    <h2>Kitapları güncelle ya da sil</h2>
      <p><?php echo("Toplam kayıt sayısı: ".$toplam);?></p>
      <p>
          <?php
          while($satir = mysqli_fetch_assoc($sorgu)){
              printf("<p>".$satir['kitapID']." - ".$satir['kitapAdi']." (<a href='eser_guncelle.php?kitapID=".$satir['kitapID']."'>Güncelle</a>) "." (<a href='eser_sil.php?kitapID=".$satir['kitapID']."'>Sil</a>) ");
          }
          ?>
      </p>
  </div>
